...
class MovePackege final :
 ...
 public:
  ...
  explicit constexpr MovePackege(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
// repeated .pb.Player ps = 1;
inline int SyncPlayer::_internal_ps_size() const {
  return ps_.size();
}
...
inline const ::pb::Player& SyncPlayer::_internal_ps(int index) const {
...
inline ::pb::Player* SyncPlayer::_internal_add_ps() {
  return ps_.Add();
}
